...
# === V Files and Targets ===
VFILES_EXE = $(EXTRACTED_DIR)/Cabs.v $(EXTRACTED_DIR)/Lexer.v $(EXTRACTED_DIR)/Helpers.v $(EXTRACTED_DIR)/Schema.v $(EXTRACTED_DIR)/extraction.v   
VOFILES_EXE = $(VFILES_EXE:.v=.vo)

VFILES_THEORIES = $(THEORIES_DIR)/Cabs.v $(EXTRACTED_DIR)/Helpers.v $(THEORIES_DIR)/Schema.v $(THEORIES_DIR)/Lexer.v 
...
prepare_theories: | $(THEORIES_DIR)
	...
	cp $(SCHEMA_DIR)/Schema.v $(THEORIES_DIR)/
	cp $(SCHEMA_DIR)/Helpers.v $(THEORIES_DIR)/
